...
public class MyhwSeedEcbUtil {
   ...
   * @return
   */
  public static String SEED_ECB_Encrypt(String key, String plainText) {
    ...
    pbszCipherTextString = Base64.getEncoder().encodeToString(pbszCipherText);
    return pbszCipherTextString;
  }
   ...
   * @return
   */
  public static String SEED_ECB_Decrypt(String key, String encrypedData) {
    KISA_SEED_INFO info = new KISA_SEED_INFO();
    int[] outbuf;
    int[] data;
    byte[] cdata;
